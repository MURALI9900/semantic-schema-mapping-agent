...
export class AppComponent {
 ...
 map(){this.loading=true;this.http.post<any>('/api/v1/semantic/map',{transactionId:'',officerId:this.officerId,request:this.request}).subscribe({next:r=>{this.result=r;this.loading=false},error:e=>{this.result={intent:'ERROR',status:'ERROR',message:'Gateway/service unavailable',confidence:0};this.loading=false}})}
